# Contributing to KitoFileViewer
...
3. Make your change. Follow
   [KitoFileViewer's engineering standards](https://github.com/WykSofts-Inc/KitoFileViewer/blob/main/docs/ENGINEERING_STANDARDS.md) —
